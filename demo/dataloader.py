...
def prepare_dataset(dataset, attr):
    num_classes, dataset, target_model, shadow_model = get_model_dataset(dataset, attr=attr)
    length = len(dataset)
...
def get_model_dataset(dataset_name, attr):
    root = '../../data'
